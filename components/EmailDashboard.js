...
const mockEmails = {
  inbox: [
    ...
    },
    {
      ...
      preview: "Ive finished the first phase of the project...",
    },
    {
      id: 3,
      from: "Bob Johnson",
      subject: "Question about the report",
      preview: "I was looking at the quarterly report and...",
    },
  ],
  sent: [
    {
      ...
      to: "Alice Brown",
      subject: "Re: Proposal",
      preview: "Thanks for your proposal. Ive reviewed it and...",
    },
    {
      id: 5,
      to: "Charlie Davis",
  ...
  starred: [
    {
      ...
      preview: "We have a crucial client meeting scheduled for...",
    },
    {
      id: 7,
      from: "Frank Miller",
      subject: "Congratulations!",
      preview: "I heard about your recent promotion. Congratulations on...",
    },
  ],
  pending: [
    {
      ...
      preview:
        "I've started working on the quarterly report. Here's what I have so far...",
    },
    {
      id: 9,
      to: "Henry Wang",
      ...
      preview:
        "Regarding our discussion about the project timeline, I think we should...",
    },
  ],
};
...
const EmailDashboard = () => {
  ...
  const handleStarEmail = (emailId) => {
    ...
    console.log(`Star email with id: ${emailId}`);
  };
